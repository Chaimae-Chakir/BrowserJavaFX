package ma.enset.browser.presentation.controllers;
...
//    }
    ...
    @FXML public void ActionHistorique() throws IOException {
        BorderPane root= FXMLLoader.load(getClass().getResource("../view/Historique.fxml"));
        ...
        BorderPane root= FXMLLoader.load(getClass().getResource("../view/Favoris.fxml"));
        Scene scene=new Scene(root);
    ...
    @FXML public void ActionTelechargement() throws IOException {
        BorderPane root= FXMLLoader.load(getClass().getResource("../view/Download.fxml"));
        Scene scene=new Scene(root);
        window3.setScene(scene);
        window3.show();
    }
